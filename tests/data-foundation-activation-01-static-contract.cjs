...
function main() {
  ...
  check(sha256(read("styles.css")) === "5b54f978d12655405ae1f1f8ed6f69da7c019da491e7aecde6a40a8e0ddff713", "styles.css must match the approved RECOVERY-OPERATIONS-INTEGRATION-01 presentation baseline");
