...
const REQUIRED_PACKAGE_ANCHORS = Object.freeze([
  "prototype.html", "app.js", "styles.css", "sample-data.js", "js/ui/obsoliq-icon-system.js",
  "assets/icons/obsoliq/icon-manifest.json", "assets/icons/obsoliq/obsoliq-icon-sprite.svg",
  "assets/icons/obsoliq/LICENSE-LUCIDE.txt", "assets/icons/obsoliq/README.md",
...
const DATA_PROVENANCE = Object.freeze({
  ...
  "assets/icons/obsoliq/icon-manifest.json": Object.freeze({ classification: "structural-template", note: "Icon identifiers and metadata only; no business or personal records." }),
